      ...
      <div className="max-w-md mx-auto px-4">
        ...
        >
          <Card className="p-8 text-center">
            <h1 className="text-3xl font-heading font-bold mb-2">Sign in to try the demo</h1>
            <p className="text-neutral-600 mb-8">
              Log in with Google to access the voice AI demo. Each account gets 2 minutes of demo time.
            </p>
            <button
              type="button"
